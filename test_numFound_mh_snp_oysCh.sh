...
#SBATCH --array=250-275%25 #specify how many jobs in the array and limit number running concurrently (e.g. 1-96%40)
...
Rscript match_foundNum_mh_snp_comparison_sim.R $x $SLURM_ARRAY_TASK_ID /90daydata/oyster_gs_sim/ ../seq_data_mh/allPhased_oysterChina.vcf
