...
# 
# This is testing script that uses the number of founders as the
# breeding population census size (i.e., number of broodstock in each generation)
# 
...
# this will be the number of broodstock used each generation
nBrood <- nInd(pop[[1]])
...
save(imputeRes, gebvRes, file = paste0("rda/test_multGen_empir_MH_small_", prefix, "_", iterationNumber, ".rda"))
